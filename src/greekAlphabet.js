...
[
  {chars: ['α', 'ά']                , default: {char: 'a' , vowel: true }},
  ...
  {chars: ['ο', 'ω', 'ό', 'ώ']           , default: {char: 'o' , vowel: true }},
  ...
  {chars: ['ει', 'η', 'ι', 'υ', 'ϊ', 'ΐ', 'ύ', 'ϋ', 'ΰ', 'ή'], default: {char: 'ee', vowel: true } , EI: true},
  {chars: ['γγ']               , default: {char: 'ng', vowel: true }},
  {chars: ['ου']               , default: {char: 'ou', vowel: true }},
  {chars: ['αι', 'ε', 'έ']          , default: {char: 'e' , vowel: true}  , endOfWord:   {char: 'ay', vowel: true } , EI: true},
